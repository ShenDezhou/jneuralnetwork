 ...
 */
package edu.packt.neuralnet.examples.chapter05;
...
/**
*
* WeatherExampleDelays
* This class performs the use case described in chapter 5 of the book 
* but using delay values. It is very similar to WeatherExample class  
* 
